...
import { diaDeFecha, talleresConAsistenciaPendiente, tallerTieneClaseEnFecha } from "../utils/talleres.js";
        ...
        <Card className="dashboard-list">
          <Card.Body>
            <div className="dashboard-panel-head">
              ...
              <span>{diaDeFecha(selectedDate)}</span>
            </div>
            <div className="daily-scroll">
              ...
              {!talleresDelDia.length ? <p className="text-muted mb-0">No hay talleres programados para hoy.</p> : null}
            </div>
          </Card.Body>
        </Card>
